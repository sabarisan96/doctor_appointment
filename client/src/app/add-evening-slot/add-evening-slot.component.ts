...
@Component({
  selector: 'app-add-evening-slot',
  templateUrl: './add-evening-slot.component.html',
  styleUrls: ['./add-evening-slot.component.scss'],
  providers: [DatePipe]
})
export class AddEveningSlotComponent implements OnInit {
